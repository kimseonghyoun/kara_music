...
$(document).ready(function(){
	...
	$("input[type='submit']").on("click",function(e){
		...
		$(".uploadResult ul li").each(function(i,obj){
			var jojb = $(obj);
			str += "<input type='text' name='attachList["+i+"].filename' value='"+jojb.data("filename")+"'>";
			str += "<input type='text' name='attachList["+i+"].uuid' value='"+jojb.data("uuid")+"'>";
			str += "<input type='text' name='attachList["+i+"].uploadpath' value='"+jojb.data("path")+"'>";
			str += "<input type='text' name='attachList["+i+"].filetype' value='"+jojb.data("type")+"'>";
		});		
